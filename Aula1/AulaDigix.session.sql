...
CREATE TABLE teste.curtidas (
    fk_aluno1 INT,
    fk_aluno2 INT,

    FOREIGN KEY (fk_aluno1) REFERENCES teste.aluno (id_aluno),
    
	FOREIGN KEY (fk_aluno2) REFERENCES teste.aluno (id_aluno)
);

CREATE TABLE teste.amigo (
    fk_aluno1 INT,
    fk_aluno2 INT,
...
INSERT INTO teste.aluno VALUES (3,'Henrique',2);

INSERT INTO teste.amigo VALUES (1,3);
INSERT INTO teste.curtidas VALUES (1,3);
	
SELECT * FROM teste.aluno INNER JOIN teste.amigo on teste.aluno.id_aluno = teste.amigo.fk_aluno1;

SELECT * FROM teste.aluno LEFT JOIN teste.amigo on teste.aluno.id_aluno = teste.amigo.fk_aluno1;

SELECT * FROM teste.aluno RIGHT JOIN teste.amigo on teste.aluno.id_aluno = teste.amigo.fk_aluno1;
